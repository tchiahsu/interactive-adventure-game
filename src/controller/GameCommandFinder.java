...
public class GameCommandFinder {
  ...
  /**
   * Splits the user command into an action and a noun, and matches the action to the
   * corresponding {@code Command} enum and uses the enum to trigger the corresponding
   * {@link ICommand} instance.
   *
